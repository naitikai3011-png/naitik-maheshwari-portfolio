      ...
      <div className="flex-1 min-h-[500px] border border-white/10 rounded-2xl overflow-hidden glass-card">
        <ResizablePanelGroup direction="horizontal" className="w-full h-full rounded-lg">
          <ResizablePanel defaultSize={75} minSize={50} className="relative overflow-y-auto">
            <div className="p-8 md:p-10 font-sans text-white/90 space-y-8 min-h-full bg-[#0f0f13]">

              <div className="text-center border-b border-white/10 pb-6">
                <h1 className="text-3xl font-display font-bold tracking-widest uppercase text-white mb-2">Naitik Maheshwari</h1>
                <p className="text-sm text-muted-foreground">Marietta, GA · 770-706-1612 · naitikmaheshwari30@gmail.com</p>
              </div>

              <section>
                <h2 className="text-xs font-bold uppercase tracking-widest text-primary border-b border-primary/30 pb-1 mb-3">Profile</h2>
              ...
              <section>
                <h2 className="text-xs font-bold uppercase tracking-widest text-primary border-b border-primary/30 pb-1 mb-3">Education</h2>
                <div>
                  <p className="font-semibold text-white text-sm">Wheeler High School Magnet Program — Center for Advanced Studies in Science, Technology & Mathematics</p>
              ...
              <section>
                <h2 className="text-xs font-bold uppercase tracking-widest text-primary border-b border-primary/30 pb-1 mb-3">Leadership & Activities</h2>
              ...
              <section>
                <h2 className="text-xs font-bold uppercase tracking-widest text-primary border-b border-primary/30 pb-1 mb-3">Projects & Research</h2>
                <ul className="space-y-3 text-sm">
                  {[
              ...
              <section>
                <h2 className="text-xs font-bold uppercase tracking-widest text-primary border-b border-primary/30 pb-1 mb-3">Awards & Honors</h2>
              ...
              <section>
                <h2 className="text-xs font-bold uppercase tracking-widest text-primary border-b border-primary/30 pb-1 mb-3">Skills</h2>
                <p className="text-sm text-white/80 leading-relaxed">
